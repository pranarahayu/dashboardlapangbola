...
with tab3:
    ...
    with pro:
        ...
        with col5:
            ...
            rdr['Percentile'] = round((rdr['Percentile']/100),2)
            st.data_editor(rdr, column_config={'Percentile':st.column_config.ProgressColumn('Percentile',min_value=0,max_value=100)},hide_index=True)
    with plo:
        col1, col2, col3, col4 = st.columns(4)
        with col1:
